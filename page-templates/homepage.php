			...
			<div class="food-slider">
				<?php while(have_rows('food')): the_row(); ?>
					<div class="food-item card">
						...
						<p><a class="stretched-link" href="<?php echo str_replace('https://www', 'https://order', $foodlink) ?>?utm_source=web-restaurant-manager" target="_blank" rel="noopener,noreferrer,nofollow"><?php the_sub_field('name'); ?></a></p>
					</div>
				<?php endwhile; ?>
			</div>
			<div class="ubereats">
